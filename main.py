...
# Vercel needs the app object to be at the top level
app = Flask(__name__)
app.debug = True
app.secret_key = os.environ.get("SECRET_KEY", "your-default-secret-key") # Use environment variable for security
...
# Vercel does not run this block
